            ...
            if ($result->num_rows > 0) {
                while ($row = $result->fetch_assoc()) {
                    ...
                    echo "<td class='action-buttons'>
                            <a href='edit_pembeli.php?id=" . $row['id'] . "' class='edit-button'>Edit</a>
                            <a href='delete_pembeli.php?id=" . $row['id'] . "' class='delete-button' onclick='return confirm(\"Yakin ingin menghapus?\")'>Hapus</a>
                          </td>";
                    echo "</tr>";
                }
            } else {
